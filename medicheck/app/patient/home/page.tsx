...
export async function PatientHomePage() {
  ...
  return (
    <div className="min-h-screen bg-black relative">
      ...
      {/* Content */}
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex items-center justify-between">
        <DashboardHeader
        ...
        <Link
          href="/chat"
          className="relative inline-block py-8 px-20 text-white font-bold text-3xl rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-white"
          style={{
